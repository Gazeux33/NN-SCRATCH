...
class TestDataloader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.batch_size = 5
        self.x_dataloader = Dataloader(self.batch_size, self.dataset)
        self.xy_dataloader = Dataloader(self.batch_size, self.dataset, self.target)
    ...
    def test_overbatch(self):
        ...
        batch_size = 5
        dataloader = Dataloader(batch_size, data)
